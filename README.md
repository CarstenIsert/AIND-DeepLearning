...
Solutions by Carsten Isert, Sept. 2017

This Repo is based on the material from https://github.com/udacity/deep-learning/
However, not everything was transferred, only the projects that I have been working on.
It contains my solutions.
...
The files with the `requirements.txt` were removed as the tools had security issues. These dependencies need to be updated.
